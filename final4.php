...
?>
	...
	<body>
		<div id = "screen">
			...
			<img  src="images/FINAL4.png"  width ="100%" onclick = "event.preventDefault()"/>
    ...
    padding:0"   id="contributors" onClick="showModal()">Contributors</button>
			...
			<form id = "ALL" name = "ALL" action = "" method = "POST">
				...
				<div class = "slide-out-div-bottomLeft1" style="height:60%;	" >
					...
					<div class="algoBox1" style="height:7%;" onclick="addRowForAlgo('PrefDiv')"><h4 style=" text-align: center;vertical-align: middle;">PrefDiv</h4></div>
					<div class="algoBox2" style="height:7%;" onclick="addRowForAlgo('pPrefDiv')"><h4 style=" text-align: center;vertical-align: middle;">pPrefDiv</h4></div>	
					<div class="algoBox3" style="height:7%;" onclick="addRowForAlgo('PageRank')"><h4 style=" text-align: center;vertical-align: middle;">PageRank</h4></div>
					<hr/>
					<div class="algoBox1" style="height:7%;" onclick="addRowForAlgo('DisC')"><h4 style=" text-align: center;vertical-align: middle;">DisC</h4></div>
					<div class="algoBox2" style="height:7%;" onclick="addRowForAlgo('K-Medoids')"><h4 style=" text-align: center;vertical-align: middle;">K-Medoids</h4></div>	
					<div class="algoBox3" style="height:7%;" onclick="addRowForAlgo('Random')"><h4 style=" text-align: center;vertical-align: middle;">Random</h4></div>
					<hr/>
