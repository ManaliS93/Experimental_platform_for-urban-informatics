  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>-->
	...
	<body>
		<div id = "screen">
			...
			<a class="link" style="color:white;margin-left:5%;text-decoration: none;"  href="#">(c) 2015 - 2017</a>
			
			<a class="link" style="color:white ;margin-left:5%;text-decoration: none;" target="_blank"  href="#">Contributors</a>
			...
			<form id = "ALL" name = "ALL" action = "" method = "POST">
				...
				<div class="slide-out-div-topRight">
					...
					<section class="gradient">
						...
						<div id="pathTable" class="new_class"></div>
							<button name="customizeBtn" onclick = "return setCustomizePathTrue()">Customize Path</button> 
						</section>
						</div>	
				</div>
				...
				<div class = "slide-out-div-bottomLeft1" style="padding: 20px;
	width: 300px;
	background: #1685ED;
	...
	z-index: 100;">
		...
		<script type = "text/javascript">
			...
			function setCustomizePathTrue(){
				customizePath =true;
				alert("Click destination in your preferred");
			}
