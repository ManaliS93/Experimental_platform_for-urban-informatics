...
?>
	...
	<body>
		<div id = "screen">
			...
			<a class="link" style="color:white;margin-left:0%;text-decoration: none; float:left;"  href="#">(c) 2015 - 2017</a>
    ...
    padding:0"   id="contributors" onClick="showModal()">Contributors</button>
			...
			<form id = "ALL" name = "ALL" action = "" method = "POST">
				...
				<div class = "slide-out-div-bottomLeft1" >
					<a class="handleBottomLeft1" href="http://link-for-non-js-users">Content</a><br>
					<!--<form id = "bottomLeft" name = "bottomLeft" action = "api.php" method = "POST">-->
						
					<div id= "algos" style="max-height:85%;overflow:auto;">
					<h3><font color="#015249">Select required algorithms:</font></h3>
						<label class="rb-switcher model0">
							<input type="checkbox" id="algo1" class = "Boxes2" name="CBTwo[]" value="0"/>
							<i></i>
						</label>1. PD(composite)<hr>
						<label class="rb-switcher model1">
							<input type="checkbox" id="algo2" class = "Boxes2" name="CBTwo[]" value="1" />
							<i></i>
						</label>2. PD(dist+pref)<hr>
						<label class="rb-switcher model2">
							<input type="checkbox" id="algo3" class = "Boxes2" name="CBTwo[]" value="2" />
							<i></i>
						</label>3. PageRank<hr>
						<label class="rb-switcher model3">
							<input type="checkbox" id="algo4" class = "Boxes2" name="CBTwo[]" value="3" />
							<i></i>
						</label>4. PD(pop+dist)<hr>
						<label class="rb-switcher model4">
							<input type="checkbox" id="algo5"  class = "Boxes2" name="CBTwo[]" value="4" />
							<i></i>
						</label>5. PD(pref) <hr>
						<label class="rb-switcher model5">
							<input type="checkbox" id="algo6" class = "Boxes2" name="CBTwo[]" value="5" />
							<i></i>
						</label>6. PD(composite+PageRank)<hr>
						<label class="rb-switcher model6">
							<input type="checkbox" id="algo7" class = "Boxes2" name="CBTwo[]" value="6" />
							<i></i>
						</label>7. PD(pref+dist+pr)<hr>
						<label class="rb-switcher model7">
							<input type="checkbox"  id="algo8" class = "Boxes2" name="CBTwo[]" value="7" />
							<i></i>
						</label>8. K-Medoids<hr>
						<label class="rb-switcher model8">
							<input type="checkbox" id="algo9" class = "Boxes2" name="CBTwo[]" value="8" />
							<i></i>
						</label>9. DisC<hr>
						<label class="rb-switcher model9">
							<input type="checkbox" id="algo10" class = "Boxes2" name="CBTwo[]" value="9" />
							<i></i>
						</label>10. Random Selection<hr>
						<label class="rb-switcher model10">
							<input type="checkbox" id="algo11" class = "Boxes2" id = "AV" name="CBTwoAllVenues" value="TRUE" />
							<i></i>
						</label>11. All Venues
						<br>
						<hr>
		...
		<script type = "text/javascript">
			...
			<script type = "text/javascript">
					...
					var driveTime;
						...
						directionsService.route({
						  ...
						  if (status === 'OK') {
							...
							json_data=JSON.stringify(response);
							localStorage.setItem("response",json_data);
							showPathTable(response,names[0],names[names.length-1],driveTime);
							//alert( response.routes[0].legs[0].duration.text );
						  } else {
							window.alert('Directions request failed due to ' + status);
						  }
				...
				function showPath(){
					...
					function showPathTable(response,source,destination,driveTime){
					var json_data=localStorage.getItem("response");
					var response=JSON.parse(json_data);
					var myTableDiv = document.getElementById("pathTable");
							//alert(myTableDiv);
							...
							var td = document.createElement('TD');
							td.width = '85';
							td.appendChild(document.createTextNode(driveTime));
							tableBody.appendChild(td);
							var td = document.createElement('TD');
							td.width = '85';
		...
		<!--<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css"/>-->
				...
				<div class="slide-out-div-topRight ">
					<a class="handleTopRight" href="http://link-for-non-js-users">Content</a><br>
						...
						<input type="radio" class="radio" name="Intensity" value="Intensity"> With Intensity
						<input type="radio" class="radio" name="withoutIntensity" value="withoutIntensity">  Without Intensity
						<input type="radio" class="radio" name="randomWalk" value="randomWalk">  Random Walk
						<section class="gradient">
						<!--<label class="rb-switcher">
						...
						<hr>
								...
								<button name="customizeBtn" onclick = "return showPath()">Show Path</button> 
								<button name="customizeBtn" onclick = " setCustomizePathTrue()">Customize Path</button> 
  ...
  <!-- Modal content -->
				...
				<div id="customPathModal" class="modal">
  ...
  <!-- Modal content -->
				  ...
				  <div class="modal-header" >
					...
					<div class="modal-body">
					<br/>
					<h3>Select destinations in your preferred order. </h3>
