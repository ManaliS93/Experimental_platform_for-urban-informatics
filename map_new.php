...
<?php
	...
	if(!isset($_SESSION['final_input'])){
		$theInput = "X";
	}
	
	
	//if( (!empty($_POST['SubmitTopLeft']))  || (!empty($_POST['SubmitBottomLeft'])) ){
		if( true ){
		...
		$errorFlag = false;
		$profileFlag = false;
		if(empty($_POST['lat']) || empty($_POST['lon']) || empty($_POST['radius']) || empty($_POST['numVenues']) || empty($_POST['algo0']) ){
			//$errorFlag = true;
		}
		else{
		...
		*/
		...
		if($errorFlag){
			...
			if($_POST['customizeText'] == 1){
				...
				//exec("javac -cp ./java-json;. Client.java");
				//exec("java -cp ./java-json;. Client ", $output);				
			}
			echo "after this";
			//print_r($output);
			echo("<br>");
...
?>
		...
		<script type="text/javascript">
			...
			$(function(){
				...
				$('.slide-out-div-topLeft').tabSlideOut({
					...
					pathToTabImage: 'images/input2.png',          //path to the image for the tab (optionaly can be set using css)
				...
				$('.slide-out-div-bottomLeft').tabSlideOut({
					...
					pathToTabImage: 'images/profiles2.png',          
					imageHeight: '39%',                           
					imageWidth: '14%',                           
					tabLocation: 'left',                    
					speed: 300,                                      
				...
				$('.slide-out-div-bottomLeft1').tabSlideOut({
					...
					pathToTabImage: 'images/Algorithms2.png',          
					imageHeight: '23%',                           
					imageWidth: '14%',                           
					tabLocation: 'left',                    
					speed: 300,                                      
				...
				$('.slide-out-div-topRight').tabSlideOut({
					...
					pathToTabImage: 'images/path2.png',          
					imageHeight: '21%',                               
					imageWidth: '7%',                               
					tabLocation: 'right',                               
					speed: 300,                                    
				...
				$('.slide-out-div-bottomRight').tabSlideOut({
					...
					pathToTabImage: 'images/analysis2.png',
					imageHeight: '50%',
					imageWidth: '8%',
					tabLocation: 'right',
					speed: 300,
			...
			function topRightReset(){
				//alert("  yooo  hhhh" );
				document.getElementById("algo1").checked = false;
				document.getElementById("algo2").checked = false;
				document.getElementById("algo3").checked = false;
				document.getElementById("algo4").checked = false;
				document.getElementById("algo5").checked = false;
				document.getElementById("algo6").checked = false;
				document.getElementById("algo7").checked = false;
				document.getElementById("algo8").checked = false;
				document.getElementById("algo9").checked = false;
				document.getElementById("algo10").checked = false;
				document.getElementById("algo11").checked = false;
	...
	<body>
		<div id = "screen">
			...
			<img  src="images/final_header.png"  width ="100%" onclick = "event.preventDefault()"/>
    ...
    padding:0"   id="contributors" onClick="showModal()">Contributors</button>
			...
			<form id = "ALL" name = "ALL" action = "" method = "POST">
				...
				function showloaderNew(){
					...
					$("#theInput").val()=prefDivNum+""+prefDivLambda;
					...
					file.write(str);
					file.close();
					//input_data.value = prefDivNum+""+prefDivLambda;
					//alert(prefDivNum+"---"+input_data);
					
					/*<?php 
					$theInput = $_GET['input_data'];
					$_SESSION['final_input'] = $theInput; 
					echo $theInput;
					echo "thisonecccccccc";?>*/
				...
				<div class = "slide-out-div-bottomLeft1" style="height:60%;	" >
					...
					<div class="algoBox1" id="algo0" style="height:7%;" onclick="addRowForAlgo('PrefDiv')"><h4 style=" text-align: center;vertical-align: middle;">PrefDiv</h4></div>
					<div class="algoBox2" id="algo1" style="height:7%;" onclick="addRowForAlgo('pPrefDiv')"><h4 style=" text-align: center;vertical-align: middle;">pPrefDiv</h4></div>	
					<div class="algoBox3" id="algo2" style="height:7%;" onclick="addRowForAlgo('PageRank')"><h4 style=" text-align: center;vertical-align: middle;">PageRank</h4></div>
					<hr/>
					<div class="algoBox1" id="algo3" style="height:7%;" onclick="addRowForAlgo('DisC')"><h4 style=" text-align: center;vertical-align: middle;">DisC</h4></div>
					<div class="algoBox2" id="algo4" style="height:7%;" onclick="addRowForAlgo('K-Medoids')"><h4 style=" text-align: center;vertical-align: middle;">K-Medoids</h4></div>	
					<div class="algoBox3" id="algo5" style="height:7%;" onclick="addRowForAlgo('Random')"><h4 style=" text-align: center;vertical-align: middle;">Random</h4></div>
					<hr/>
					...
					<br>
						...
						<section class="gradient">
							<input type="submit" name="SubmitTopRight" value="Run" onclick="return showloaderNew()" />
						    <input type="Button" name="CancelTopRight" value="Reset" onclick="topRightReset()" />
							<br>
		...
		<script type = "text/javascript">
			...
			<script type = "text/javascript">
				...
				function calculateAndDisplayRoute(directionsService, directionsDisplay,locations,waypts,names) {
				...
				function showPath(){
					...
					//Names of the places to be displayed
					var names = venNameString.split(",");
						calculateAndDisplayRoute(directionsService, directionsDisplay,locations,waypts,names);
					}
					
					
					function showPathTable(response,source,destination){
					var json_data=localStorage.getItem("response");
					var response=JSON.parse(json_data);
					var myTableDiv = document.getElementById("pathTable");
							//alert(myTableDiv);
		...
		<!--<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css"/>-->
				...
				<div class="slide-out-div-topRight ">
					<a class="handleTopRight" href="http://link-for-non-js-users">Content</a><br>
						...
						<form>
						<input type="radio" class="radio" name="Intensity" value="Intensity"> Intensity Rank
						<input type="radio" class="radio" name="Intensity" value="withoutIntensity">  Similarity Rank
						<input type="radio" class="radio" name="Intensity" value="randomWalk">  Random Walk
						</form>
						<section class="gradient">
						<!--<label class="rb-switcher">
				...
				<div id ="theInput" style="display :none;"></div>
  ...
  <!-- Modal content -->
				  ...
				  <div class="modal-header" >
					...
					<p>Xiaoyu Ge</p>  
					 ...
					 <div class="modal-footer" ><img src="images/footerLogos.png"style="width:95%;" /></div>
				...
				<div id="addAlgoModal" class="modal">
				  ...
				  <div class="modal-header" >
					...
					<br/>
					Algorithm Name:
					<input type = "text" class = "addAlgoText" id = "addAlgoText" size = "8" value = "" />
					<br/>
					  
					  <button id="addAlgoSubmit" class="addAlgoSubmit" onclick = "addAlgo()" >Submit</button>
				  ...
				  <div class="modal-header" >
					...
					<input type = "text" class = "rangeText" id = "rangeText"  value = "" /-->
					  ...
					  <section class="gradient">
						    ...
						    <input type="Button" id="x" name="Submit"  value ="Submit" onclick="sendLambdaSigma($('#txtLambda').val(),$('#txtSigma').val())" />
				...
				<div id="customAlgoModal2" class="modal">
				  ...
				  <div class="modal-header" >
					...
					<br/>
					<BR/>
					<input type = "text" class = "rangeText" id = "txtAlpha"  value = "" placeholder="0.2" onkeyup="showSigma(this.value,'alpha')" /> * [ ( T +
					...
					<input type = "text" class = "rangeText" id = "rangeText"  value = "" /-->
					  ...
					  <section class="gradient">
						    ...
						    <input type="Button" id="x" name="Submit"  value ="Submit" onclick="" />
				...
				function addAlgo(){
					//alert("adding");
					var algoName=document.getElementById("addAlgoText");
					var p = document.getElementById("algos");
					
					var label = document.createElement("LABEL");
					label.setAttribute('class', "rb-switcher model10");
					label.innerHTML = "<i></i>"+algoIndex+"."+algoName.value+"<hr>";
					p.appendChild(label);
				...
				var modal = document.getElementById('myModal');
					...
					function sendLambdaSigma(lambda,sigma){
						
						alert(lambda+" - "+sigma);
						prefDivLambda+="//"+lambda+"*"+sigma;
