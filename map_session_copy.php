...
?>
		...
		<script type="text/javascript">
			...
			$(function(){
				...
				$('.slide-out-div-topLeft').tabSlideOut({
					...
					imageHeight: '25%',                               //height of tab image
					imageWidth: '12%',                               //width of tab image    
				...
				$('.slide-out-div-bottomLeft1').tabSlideOut({
					...
					pathToTabImage: 'images/path.jpg',          
					imageHeight: '27%',                           
					imageWidth: '12%',                           
					tabLocation: 'left',                    
					speed: 300,                                      
	...
	<body>
		<div id = "screen">
			...
			<footer style="background:#80b3ff; margin-bottom :0px;z-index: 0.9;height:20%;width:100%" >
			...
			<a class="link" style="color:white;margin-left:5%;text-decoration: none; margin-right:5%;"  href="#">(c) 2015 - 2017</a>
		...
		<!--<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css"/>-->
				...
				<div class="slide-out-div-topRight ">
					<a class="handleTopRight" href="http://link-for-non-js-users">Content</a><br>
						...
						<section class="gradient">
						<label class="rb-switcher">
						<input type="checkbox" id="noIntensity" class = "Boxes2" name="CBTwo[]" value="0" style="display: none;" />
						<i></i> With Intensity
						</label>
  ...
  <!-- Modal content -->
				  <div class="modal-content"style="width:40%;background-color: #f2efe8;" >
				  <div class="modal-header" >
